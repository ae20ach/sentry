  ...
  [
    {
      ...
      description: t(
        'Fraction of time the Node.js event loop is active (0-100%). High utilization means less capacity to handle new work and may indicate CPU-bound processing or blocking operations.'
      ),
    ...
    },
    {
      ...
      description: t(
        'Average CPU usage across all cores. Values above 1.0 (100%) are possible on multi-core systems. Sustained high utilization may indicate compute-bound workloads or insufficient scaling.'
      ),
      displayType: DisplayType.BIG_NUMBER,
      widgetType: WidgetType.TRACEMETRICS,
      interval: INTERVAL,
    ...
    },
    {
      ...
      description: t(
        'Cumulative process uptime. Sudden resets indicate process crashes or restarts. Useful for detecting instability and correlating with deployment events.'
      ),
      displayType: DisplayType.BIG_NUMBER,
      widgetType: WidgetType.TRACEMETRICS,
      interval: INTERVAL,
