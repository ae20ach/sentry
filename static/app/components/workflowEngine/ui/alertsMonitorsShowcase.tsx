...
export function openAlertsMonitorsShowcase({organization}: {organization: Organization}) {
...
function AlertsMonitorsShowcase(props: ModalRenderProps) {
            ...
            <ul>
              ...
              <li>
                <Text>
                  ...
                  {t('(managed by Sentry)')}
                  {' — '}
                  {t('groups incoming errors into issues based on your project settings')}
                </Text>
              </li>
            </ul>
          </Stack>
