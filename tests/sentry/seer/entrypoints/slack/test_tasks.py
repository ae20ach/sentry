...
class ProcessMentionForSlackTest(TestCase):
    ...
    def test_happy_path(self, mock_resolve_user, mock_agent_cls, mock_operator_cls):
    ...
    @patch("sentry.seer.entrypoints.slack.tasks.SlackAgentEntrypoint")
    @patch("sentry.seer.entrypoints.slack.tasks._resolve_user")
    def test_with_thread_context(self, mock_resolve_user, mock_agent_cls, mock_operator_cls):
